...
我想学很多各种各样的东西，所以我不会深入去学习、去理解各种轮子（前端相关方面的轮子）是如何写出来的，即我是不会去看源码的！如果看的话，我只会了解这个轮子之所以被制造的设计思想！

总之，我想像使用电风扇那样使用轮子，我不想知道这台电风扇是如何制造出来的，我也不想知道这个Vue框架是如何写出来的

我只知道，我还有笔债务咩有还，那就是有关「数据结构算法」、「操作系统」、「网络」等基础知识的学习，还咩有去学习过！

毕竟，此时我去看源码的话，这性价比是在是太低了。吾生有涯而学无涯
